# -*- coding: utf-8 -*-
"""
Created on Mon Apr 29 16:08:55 2024
...
for _ in range(100):
    ...
    for test_year in test_years:
        ...
        X_train = train_data[['NINA1_std_t_1', 'z500_std_t_1', 'PPt']].values
        y_train = train_data['target'].values

        X_test_df = test_data[['NINA1_std_t_1', 'z500_std_t_1', 'PPt']]  # Selecting columns from DataFrame
